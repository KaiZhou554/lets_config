<!--
  BubbleButton — animated bubble background button.
  Copyright (c) 2026 mdanarul_9390 (Md Anarul Sarder)
  Licensed under the MIT License.
-->
<template>
  <button class="bubble-btn">
    <span class="bubble-layer bubble-1" />
    <span class="bubble-layer bubble-2" />
    <span class="bubble-layer bubble-3" />
    <span class="bubble-layer bubble-4" />
    <span class="bubble-layer bubble-5" />
    <span class="bubble-layer bubble-6" />
    <span class="bubble-layer bubble-7" />
    <span class="label"><slot /></span>
  </button>
</template>

<script setup lang="ts">
// BubbleButton.vue — animated floating bubbles behind label.
</script>
